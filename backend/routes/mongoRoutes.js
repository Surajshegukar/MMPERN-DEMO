...
// POST new item
router.post("/items", itemValidationRules, validateRequest, setItem);

// PUT update item
router.put("/items/:id", itemValidationRules, validateRequest, updateItem);

// DELETE item
router.delete("/items/:id", deleteItem);

router.post("/ajax/items", getAjaxItems);
